...
namespace DataStructure.QueueBFS.SnakeLadder
{
    public class SnakesLadder
    {
            ...
            while (q.Count != 0)
            {
                ...
                for (int j = v + 1; j <= (v + 6) && j < n; ++j)
                {
                    ...
                    if (visited[j] == 0)
                    {
                        ...
                        // mark it as visited  
                        Board a = new Board { Dist = (qe.Dist + 1) };
                        visited[j] = 1;
        ...
        public static void Main1(String[] args)
        {
            ...
            Console.WriteLine("Min Dice throws required is " + GetMinDiceThrows(moves, N));
        }
    }
}
